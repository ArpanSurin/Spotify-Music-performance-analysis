...
This project analyzes Spotify track performance data using PostgreSQL to uncover insights related to artist popularity, track engagement, and platform performance (Spotify vs YouTube).
The analysis focuses on answering business-driven questions and presenting results through a clean, executive-friendly Power BI dashboard.
